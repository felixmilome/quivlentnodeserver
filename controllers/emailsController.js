...
//nodemailer transporter console
 const transporter = nodemailer.createTransport({
                  ...
                  <div class="content">
                    ...
                    <div class="footer">
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td class="content-block powered-by">
                            <img src=${logoUrl} alt="Trademark" width="100" height="100">
                          </td>
                        </tr>
                      </table>
                    </div>
  ...
  exports.sendSecurityEmail = async (userEmail, uniqueStr, username, userId, change) => {


    const mailOptions = {
      from: 'Zoorura <noreply@zoorura.com>', 
      to: userEmail, 
      subject:`Zoorura ${change} changed`,
      html: `<!doctype html>
      <html>
        <head>
          <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td>
                              ...
                              <a href= "${mainUrl}/securityChange/${change}/${userId}/${uniqueStr}"> <h1>CHANGE MY ${change}</h1> </a>

                              <p>ALL PREVIOUS VERIFY LINKS HAVE EXPIRED. If you did not request this change, Ignore or Report to security@zoorura.com</p>
 ...
 exports.sendDeleteAccountEmail = async (userEmail, uniqueStr, username, userId) => {


    const mailOptions = {
      from: 'Zoorura <noreply@zoorura.com>', 
      to: userEmail, 
      subject:`Zoorura Delete Account Request`,
      html: `<!doctype html>
      <html>
        <head>
          <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td>
                              ...
                              <p>Helo @<b>${username}</b>, You requested to PERMANENTLY DELETE ACCOUNT. If you did, CLICK BELOW.</p>
                              
                              <a href= "${mainUrl}/securityChange/deleteAccount/${userId}/${uniqueStr}"> <h1>DELETE MY ACCOUNT</h1> </a>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td class="content-block">
                          <span class="apple-link">Zoorura Technologies Ltd, Nairobi, Kenya</span>
                          <br> This is an auto generated email for @${username}. Please do not reply
                          <br> Ignore if it is not you. Or report violation to security@zoorura.com </a>
                        </td>
                      </tr>
                      <tr>
                        <td class="content-block powered-by">
...
exports.sendWarningEmail = async (userEmail, warning, username, message) => {
...
const mailOptions = {
  ...
  <html>
    <head>
      <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
      <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
      <title>Zoorura Alert Email</title>
      <style>
        /* -------------------------------------
            GLOBAL RESETS
        ------------------------------------- */
              ...
              <div class="footer">
                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="content-block">
                      <span class="apple-link">Zoorura Technologies Ltd, Nairobi, Kenya</span>
                      <br> This is an auto generated email for @${username}. 
                    </td>
                  </tr>
                  <tr>
                    <td class="content-block powered-by">
